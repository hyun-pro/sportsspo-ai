...
// In production, replace with real data sources (공공데이터포털, 소상공인진흥공단 API, etc.)

export function generateMockAnalysisData(address: string, lat: number, lng: number) {
  ...
  return {
    ...
    sales: {
      ...
      byIndustry: [
        { name: '음식점', amount: rand(5000000, 80000000), ratio: 0 },
        { name: '카페/음료', amount: rand(3000000, 40000000), ratio: 0 },
        { name: '소매/편의점', amount: rand(2000000, 30000000), ratio: 0 },
        { name: '미용/건강', amount: rand(1000000, 20000000), ratio: 0 },
        { name: '교육/학원', amount: rand(1000000, 15000000), ratio: 0 },
        { name: '기타', amount: rand(500000, 10000000), ratio: 0 },
      ],
    },
    ...
    competitors: {
      ...
      openRate: rand(5, 20),  // % new businesses in last year
      closeRate: rand(3, 15), // % closed businesses in last year
    },
